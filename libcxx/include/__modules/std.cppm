...
#  endif
  ...
  using std::barrier;
#endif // _LIBCPP_HAS_NO_THREADS  // [bit.cast], bit_cast
  using std::bit_cast;
  ...
  // [bit.endian], endian
  using std::endian;  using std::bitset;
  ...
  using std::hash;
  // This module exports nothing.  using std::isalnum;
  using std::isalpha;
  using std::isblank;
  using std::iscntrl;
  using std::isdigit;
  ...
  using std::isxdigit;
  using std::tolower;
  using std::toupper;  // This module exports nothing.  // types
  using std::fenv_t;
  using std::fexcept_t;
...
export namespace std {
  ...
  // conflicing declarations omit the using here.  // This module exports nothing.#ifndef _LIBCPP_HAS_NO_LOCALIZATION
  using std::lconv;
...
#endif#ifndef _LIBCPP_HAS_NO_LOCALIZATION
...
#  endif // _LIBCPP_STD_VER < 26 || defined(_LIBCPP_ENABLE_CXX26_REMOVED_CODECVT)
  ...
  using std::suspend_never;  using std::jmp_buf;
  using std::longjmp;  using std::sig_atomic_t;

  // [support.signal], signal handlers
  using std::signal;

  using std::raise;
  using std::va_list;  using std::max_align_t;
  using std::nullptr_t;
  using std::ptrdiff_t;
  using std::size_t;
  ...
  using std::uintptr_t _LIBCPP_USING_IF_EXISTS;  using std::FILE;
  using std::fpos_t;
  using std::size_t;
  ...
  using std::vsnprintf;
  using std::vsprintf;
  using std::vsscanf;  using std::div_t;
  using std::ldiv_t;
  using std::lldiv_t;
  using std::size_t;
  ...
  using std::div;
  using std::ldiv;
  using std::lldiv;  using std::size_t;
  ...
  using std::strstr;
  using std::strtok;
  using std::strxfrm;  using std::clock_t;
  using std::size_t;
  using std::time_t;
  ...
  using std::strftime;
  using std::time;
  using std::timespec_get _LIBCPP_USING_IF_EXISTS;  // Note the Standard does not mark these symbols optional, but libc++'s header
  ...
  using std::c32rtomb _LIBCPP_USING_IF_EXISTS;#ifndef _LIBCPP_HAS_NO_WIDE_CHARACTERS
  using std::mbstate_t;
  using std::size_t;
  using std::wint_t;
  ...
  using std::wcrtomb;
  using std::wcsrtombs;
#endif // _LIBCPP_HAS_NO_WIDE_CHARACTERS#ifndef _LIBCPP_HAS_NO_WIDE_CHARACTERS
  using std::wctrans_t;
  using std::wctype_t;
  using std::wint_t;
  ...
  using std::wctrans;
  using std::wctype;
#endif // _LIBCPP_HAS_NO_WIDE_CHARACTERS  // [deque], class template deque
  using std::deque;
...
export namespace std {
  ...
  using std::sorted_equivalent;
  using std::sorted_equivalent_t;
#endif  // [format.context], class template basic_format_context
  ...
  using std::format_error;  // [forward.list], class template forward_list
...
#  ifndef _LIBCPP_HAS_NO_WIDE_CHARACTERS
  using std::wfstream;
#  endif
#endif // _LIBCPP_HAS_NO_LOCALIZATION  // [func.invoke], invoke
  using std::invoke;
#if _LIBCPP_STD_VER >= 23
  using std::invoke_r;
#endif
  ...
  } // namespace ranges#ifndef _LIBCPP_HAS_NO_THREADS
  ...
  using std::async;
#endif // _LIBCPP_HAS_NO_THREADS#if 0
  using std::generator;
#endif#if 0
#  if _LIBCPP_STD_VER >= 23
  ...
  using std::swap;
#  endif // _LIBCPP_STD_VER >= 23
#endif  using std::initializer_list;

  // [support.initlist.range], initializer list range access
  using std::begin;
  using std::end;#ifndef _LIBCPP_HAS_NO_LOCALIZATION
  using std::get_money;
  using std::get_time;
  using std::put_money;
  using std::put_time;
  ...
  using std::quoted;
#endif // _LIBCPP_HAS_NO_LOCALIZATION  using std::streampos;
#ifndef _LIBCPP_HAS_NO_WIDE_CHARACTERS
...
#  endif
  ...
  using std::fpos;#ifndef _LIBCPP_HAS_NO_LOCALIZATION
  using std::fpos;
...
#  ifndef _LIBCPP_HAS_NO_WIDE_CHARACTERS
  using std::wios;
#  endif
#endif // _LIBCPP_HAS_NO_LOCALIZATION#ifndef _LIBCPP_HAS_NO_LOCALIZATION
  using std::cerr;
  using std::cin;
  using std::clog;
  using std::cout;
...
#  endif
  ...
  using std::operator>>;
#endif // _LIBCPP_HAS_NO_LOCALIZATION  // [iterator.assoc.types], associated types
  ...
  // [depr.iterator]
  using std::iterator;#ifndef _LIBCPP_HAS_NO_THREADS
  using std::latch;
#endif // _LIBCPP_HAS_NO_THREADS  // [fp.style], floating-point type properties
  using std::float_denorm_style;
  using std::float_round_style;

  // [numeric.limits], class template numeric_­limits
  using std::numeric_limits;  // [list], class template list
  using std::list;
...
#endif // _LIBCPP_HAS_NO_LOCALIZATION  // [map], class template map
  using std::map;
  ...
  } // namespace pmr#if _LIBCPP_STD_VER >= 23
  ...
  using std::mdspan;
#endif // _LIBCPP_STD_VER >= 23  // [pointer.traits], pointer traits
...
export namespace std {
  ...
  using std::call_once;  // [alloc.errors], storage allocation errors
  using std::bad_alloc;
...
export namespace std {
  ...
  using std::hash;#ifndef _LIBCPP_HAS_NO_LOCALIZATION
...
#endif // _LIBCPP_HAS_NO_LOCALIZATION#if _LIBCPP_STD_VER >= 23
...
#  ifndef _LIBCPP_HAS_NO_UNICODE
  using std::vprint_unicode;
#  endif // _LIBCPP_HAS_NO_UNICODE
#endif   // _LIBCPP_STD_VER >= 23  // [queue], class template queue
  using std::queue;
  ...
  using std::priority_queue;  // [rand.req.urng], uniform random bit generator requirements
  ...
  using std::piecewise_linear_distribution;  namespace ranges {
    inline namespace __cpo {
...
#endif // _LIBCPP_STD_VER >= 23  // [ratio.ratio], class template ratio
  using std::ratio;
...
#  endif
...
#endif // _LIBCPP_HAS_NO_LOCALIZATION  // class template scoped_allocator_adaptor
...
#endif // _LIBCPP_HAS_NO_THREADS  // [set], class template set
  using std::set;
  ...
  namespace pmr {
    ...
    using std::pmr::set;
  } // namespace pmr#ifndef _LIBCPP_HAS_NO_THREADS
  ...
  using std::swap;
#endif // _LIBCPP_HAS_NO_THREADS  using std::source_location;  // constants
  ...
  using std::as_writable_bytes;#if 0
...
#  endif
#endif // _LIBCPP_HAS_NO_LOCALIZATION  // [stack], class template stack
  using std::stack;
  ...
  using std::underflow_error;#if defined(__STDCPP_FLOAT16_T__)
  using std::float16_t;
#endif
...
#  endif // _LIBCPP_ENABLE_EXPERIMENTAL
#endif   // _LIBCPP_HAS_NO_THREADS#ifndef _LIBCPP_HAS_NO_LOCALIZATION
  using std::basic_streambuf;
  using std::streambuf;
#  ifndef _LIBCPP_HAS_NO_WIDE_CHARACTERS
  using std::wstreambuf;
#  endif
#endif // _LIBCPP_HAS_NO_LOCALIZATION  // [char.traits], character traits
  ...
  } // namespace literals  // [string.view.template], class template basic_string_view
  ...
  }   // namespace literals#ifndef _LIBCPP_HAS_NO_LOCALIZATION
  using std::istrstream;
  using std::ostrstream;
  using std::strstream;
  using std::strstreambuf;
#endif // _LIBCPP_HAS_NO_LOCALIZATION#if !defined(_LIBCPP_HAS_NO_LOCALIZATION) && !defined(_LIBCPP_HAS_NO_EXPERIMENTAL_SYNCSTREAM)
  using std::basic_syncbuf;
...
#  ifndef _LIBCPP_HAS_NO_WIDE_CHARACTERS
  using std::wosyncstream;
#  endif
#endif // !defined(_LIBCPP_HAS_NO_LOCALIZATION) && !defined(_LIBCPP_HAS_NO_EXPERIMENTAL_SYNCSTREAM)  using std::error_category;
  ...
  using std::is_error_condition_enum_v;#if 0
#  if _LIBCPP_STD_VER >= 23
...
#  endif
  ...
  using std::hash;
#endif // _LIBCPP_HAS_NO_THREADS  // [tuple.tuple], class template tuple
  using std::tuple;
  ...
  // [tuple.helper], tuple helper classes
  using std::tuple_size_v;  using std::hash;
  using std::type_index;  using std::bad_cast;
  using std::bad_typeid;
  using std::type_info;  // [meta.help], helper class
  ...
  using std::is_pod;
  using std::is_pod_v;  // [unord.map], class template unordered_­map
  ...
  } // namespace pmr  // [unord.set], class template unordered_­set
  ...
  } // namespace pmr  // [utility.swap], swap
  using std::swap;
  ...
  namespace rel_ops {
    ...
    using rel_ops::operator<=;
    using rel_ops::operator>=;
  } // namespace rel_ops  using std::gslice;
  ...
  using std::begin;
  using std::end;  // [variant.variant], class template variant
  using std::variant;
  ...
  using std::hash;  // [vector], class template vector
  using std::vector;
  ...
  using std::formatter;
#endif  // This module exports nothing.
  // [any.bad.any.cast], class bad_any_cast
  using std::bad_any_cast;
